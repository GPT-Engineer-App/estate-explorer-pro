...
const Index = () => {
  return (
    <Container centerContent maxW="container.md" height="100vh" width="100vw" display="flex" flexDirection="column" justifyContent="center" alignItems="center" px={4} bgImage="url('/images/hero-image.jpg')" bgSize="cover" bgPosition="center" bgRepeat="no-repeat">
      <VStack spacing={4}>
